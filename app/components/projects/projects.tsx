  ...
  return (
    <section className="section-bottom-padding">
      <header className="section-header auto-show">
        ...
        <p className="section-subtitle">These are some of my projects and technologies I use. Click them to see more details.</p>
      </header>
      <div className="project-grid">
        {projectData.map((project) => (
          <ProjectList key={project.id} id={project.id} trigger={<ProjectCard project={project} />}>
